// Sample program to show how maps behave
// when you read an absent key.
...
func main() {
	...
	// Read the element at a key "anna". It is absent so we get
	...
	// Without this bahavior we would have to code in
	// a defensive way like this:
